...
df = pd.read_csv('https://raw.githubusercontent.com/levyjeff/data_skills_1_hw5/main/hw4_data.csv')
...
#https://www.google.com/search?q=assert+python&rlz=1C5CHFA_enUS868US868&oq=assert+&aqs=chrome.0.69i59j69i57j0i433i512j0i512j0i67i650j0i433i512j0i67i650j69i60.6283j1j4&sourceid=chrome&ie=UTF-8
...
import os
os.chdir('/Users/laura/Desktop/GitHub/HW5')
...
!pip install --upgrade us
# transform full state name to abbreviation

def convert(state):
    return us.states.mapping('name', 'abbr').get(state)
policy_wide['state'] = policy_wide['state'].map(convert)
policy_wide
...
def get_zscore(cols):
    ...
    cols = (cols - avg) / sd
    return cols
#https://stackoverflow.com/questions/57418413/loop-through-dataframe-cols-and-rows-and-replace-data
